...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.bulkInsert('QuestionTranslations', [
      ...
      { language: 'fr', createdAt: new Date(), updatedAt: new Date(), description: "Votre projet est-il éligible aux CliniMakers? En d'autres termes: faites-vous quelque chose pour un enfant malade ou handicapé et connaissez-vous (de préférence) la personne vous-même.", positive: 'Qui', negative: 'Non', questionId: 4 },
