...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.bulkInsert('Questions', [
      ...
      { name: 'CliniMaker', createdAt: new Date(), updatedAt: new Date(), eventId: 2 }
    ], {});
    await queryInterface.bulkInsert('QuestionTranslations', [
      ...
      { language: 'nl', createdAt: new Date(), updatedAt: new Date(), description: "Mag coderdojo foto's/video's nemen tijdens het evenement?", positive: 'Ja, dat mag', negative: 'Neen, liever niet', questionId: 1 },
      ...
      { language: 'en', createdAt: new Date(), updatedAt: new Date(), description: 'Could your project qualify as a CliniMakers project? In other words: do you plan to make something for a child that is ill or has a disability and you (preferably) know this person.', positive: 'Yes', negative: 'No', questionId: 8 },
      ...
      { language: 'fr', createdAt: new Date(), updatedAt: new Date(), description: "Votre projet est-il éligible aux CliniMakers? En d'autres termes: faites-vous quelque chose pour un enfant malade ou handicapé et connaissez-vous (de préférence) la personne vous-même.", positive: 'Oui', negative: 'Non', questionId: 8 },
      ...
      { language: 'nl', createdAt: new Date(), updatedAt: new Date(), description: 'Komt jouw project in aanmerking voor de CliniMakers? Dus maak jij iets voor een kind die ziek is of een beperking heeft én (liefst) ken je de persoon ook zelf.', positive: 'Ja', negative: 'Neen', questionId: 8 }
    ], {});
  },
